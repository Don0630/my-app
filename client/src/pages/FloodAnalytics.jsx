  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 relative">
        ...
        {/* Legend */}
        <div className="absolute top-4 right-4 bg-white/30 dark:bg-white-300/30 backdrop-blur-md shadow-lg rounded-lg p-2 text-xs z-[1000] w-40">
