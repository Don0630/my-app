  ...
  return (
    <div className="grid gap-6 lg:grid-cols-1">
      <div className="bg-white dark:bg-gray-800 shadow">
        {/* Header - sticky */}
        <div className="bg-pink-600 text-white px-4 py-2 flex justify-between items-center sticky top-0 z-[1001]">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="px-2 py-1 sm:px-2 sm:py-1 bg-white text-pink-700 rounded shadow flex items-center justify-center"
            >
