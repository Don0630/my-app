        ...
        <div className="bg-cyan-600 text-white px-4 py-2 flex justify-between items-center sticky top-0 z-[1001]">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="px-2 py-1 sm:px-2 sm:py-1 bg-white text-cyan-700 rounded shadow flex items-center justify-center"
            >
          ...
          <div className="absolute top-4 right-4 bg-white/30 dark:bg-white-900/30 backdrop-blur-md shadow rounded-lg p-2 text-xs z-[1000] w-40">
            ...
            <ul className="flex flex-col items-center gap-1">
              {[
                ...
                { color: "#00838f", label: "20 - 25" },
                { color: "#006064", label: "25+" },
              ].map((item, idx) => (
