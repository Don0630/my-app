      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow">
        <div className="bg-cyan-600 text-white px-4 py-2 flex justify-between items-center">
          <h3 className="font-semibold flex items-center gap-2">
            <Briefcase size={16} /> Business Location Analytics
          </h3>
        ...
        <div className="relative h-[800px]">
          ...
          <div className="absolute top-4 left-4 bg-white/30 dark:bg-white-900/30 backdrop-blur-md shadow rounded-lg p-3 w-52 z-[1000]">
            ...
            {selected ? (
              <div className="mt-1">
                ...
                <p className="text-xs text-gray-700 dark:text-gray-700">Businesses: {selected.value}</p>
              </div>
            ) : (
          ...
          <div className="absolute top-4 right-4 bg-white/30 dark:bg-white-900/30 backdrop-blur-md shadow rounded-lg p-2 text-xs z-[1000] w-40">
            ...
            {[
              { color: "#80deea", label: "0 - 5" },
              { color: "#26c6da", label: "5 - 10" },
              { color: "#00acc1", label: "10 - 15" },
              { color: "#0097a7", label: "15 - 20" },
