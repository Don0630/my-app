  ...
  return (
    <div className="grid gap-6 lg:grid-cols-1">
      <div className="bg-white dark:bg-gray-800 shadow rounded-xl">
        {/* Header */}
        <div className="bg-cyan-600 text-white px-4 py-2 flex justify-between items-center sticky top-0 z-[1001]">
          ...
          <div className="absolute top-4 left-4 bg-white/30 dark:bg-white-900/30 backdrop-blur-md shadow rounded-lg p-3 w-52 z-[1000]">
            ...
            {selected ? (
              <div className="mt-1">
                ...
                <p className="text-xs text-gray-700 dark:text-gray-700">Businesses: {selected.count}</p>
              </div>
            ) : (
